    ...
    var main = function(img, options){
        ...
        function updateBgStyle() {
            ...
            if (bgPosX === 0 && bgPosY === 0) {
                ...
                if (img.style.backgroundPosition === 'center center') {

                }
                //img.style.backgroundPosition = bgPosX + 'px ' + bgPosY + 'px';
                img.style.backgroundPosition =  'calc(50% + '+bgPosX+'px) calc(50% + ' + bgPosY + 'px)';
            }
        }
        ...
        function onwheel(e) {
            ...
            //console.log(offsetX, bgWidth, bgRatioX);
        ...
        function drag(e) {
            e.preventDefault();
            bgPosX += (e.pageX - previousEvent.pageX) * zoomScale * 5;
            bgPosY += (e.pageY - previousEvent.pageY) * zoomScale * 5;
            previousEvent = e;
            updateBgStyle();
        }
